...
import {selectRequirementById} from "../../redux/Requirement/RequirementSlice";
...
export function RequirementDetailsPage(props: any) {
    ...
    return (
        <>
            <Row gutter={[16, 16]} align={"middle"}>
                ...
                <Col xs={22} xl={23}>
                    <Title style={{marginBottom: 0}}>{requirement?.paragraph_number} {requirement?.title}</Title>
            ...
            <Row gutter={[16, 16]} align={"middle"}>
                ...
                <Text>Tips about how to satisfy this requirement: : Create a document where you define who in your
                    organisation contributes to information security operations. In case you are doing business with EU
                    customers, You will definitely need a DPO (Data Protection Officer). DPO is …</Text>
            </Row>

            <Row gutter={[16, 16]}>
                <Col xs={{span: 24, offset: 1}} sm={24} md={24} lg={{span: 17, offset: 1}}
                     xl={{span: 17, offset: 1}}>
                    <Title level={3} style={{paddingBottom: 0, marginBottom: 0}}>Connected controls</Title>
                </Col>
            </Row>
            ...
            <Row gutter={[16, 16]}>
                <Col xs={{span: 24, offset: 1}} sm={24} md={24} lg={{span: 17, offset: 1}}
                     xl={{span: 17, offset: 1}}>
                    <Table
                        dataSource={requirement?.controls}
                        columns={columns}
                        rowKey="id"
                        style={{width: "100%"}}
                        pagination={false}
