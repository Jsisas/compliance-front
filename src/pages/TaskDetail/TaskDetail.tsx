	...
	return (
		<>
				...
				<Col xs={{span: 24, offset: 1}} sm={24} md={24} lg={{span: 17, offset: 1}}
					...
					<Dragger {...props} openFileDialogOnClick={false}>
						...
						<div style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
							...
							<Text>or</Text>
							<AddLinkModal onAdd={(link: AddLink) => onLinkAdd(link)} isVisible={isAddLinkModalVisible}
										  onCancel={toggleModal}/>
							<AlButton type="link" className={styles.buttonPadding}
									  onClick={() => setAddLinkModalVisible(!isAddLinkModalVisible)}>add link</AlButton>
						</div>
					</Dragger>
				</Col>
			</Row>
			...
			<Row gutter={[16, 16]}>
				<Col xs={{span: 24, offset: 1}} sm={24} md={24} lg={{span: 17, offset: 1}}
					 xl={{span: 17, offset: 1}}>
					<AlButton type="primary"
							  onClick={() => notifyError('Not implemented', 'This feature is not implemented')}>Add
						comment</AlButton>
				</Col>
			</Row>
			<Row gutter={[16, 16]}>
